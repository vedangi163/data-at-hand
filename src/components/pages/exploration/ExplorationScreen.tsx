...
import { StatusBar, View, StyleSheet, Platform, BackHandler, Alert, AppState, AppStateStatus, Text, TextInput, TouchableOpacity } from "react-native";
...
import { ProfilePanel } from "@components/pages/exploration/parts/main/ProfilePanel";
...
class ExplorationScreen extends React.PureComponent<ExplorationProps, State> {
    ...
    private CompBottomSheetRef = React.createRef<TouchSafeBottomSheet>()
    private compBottomSheetRef = React.createRef<TouchSafeBottomSheet>()
    ...
    onBottomBarButtonPress = (mode: ExplorationMode) => {
        switch (mode) {
            ...
            case ExplorationMode.Compare:
                ...
                break;
            default:
               this.CompBottomSheetRef.current?.open()
